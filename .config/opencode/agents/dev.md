...
1. Read Architect's assignment carefully, including objective, acceptance criteria, owned files, no-touch boundaries, constraints, and verification commands.
...
4. Modify only the assigned files. Preserve unrelated user changes and never revert work you did not make unless explicitly instructed. If the required fix crosses an ownership boundary, report the dependency instead of editing another agent's scope.
