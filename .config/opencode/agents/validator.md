---
description: Independently runs targeted verification for completed changes, keeping verbose test output out of the primary context and never editing source files.
mode: subagent
